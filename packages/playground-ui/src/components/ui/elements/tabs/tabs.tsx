...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List ref={ref} className={cn('border-b border-border1 mb-[1.75rem]', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'text-[0.9375rem] py-[0.5rem] px-[1.5rem] font-normal text-icon3 border-b-[3px] border-transparent',
