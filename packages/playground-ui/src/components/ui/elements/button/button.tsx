...
export const Button = ({ className, as, size = 'md', variant = 'default', ...props }: ButtonProps) => {
  ...
  return (
    <Component
      className={cn(
        'text-[.875rem] inline-flex items-center justify-center rounded-md  px-[1rem] gap-[.75rem] min-h-[2.5rem] leading-0 border  bg-transparent text-[rgba(255,255,255,0.7)] border-[rgba(255,255,255,0.15)]',
